                ...
                <DialogContent>
                    <Box sx={{
                        ...
                        <Stack direction={isSmartphone ? "column" : "row"} spacing={isSmartphone ? 1 : 4} sx={{
                            ...
                            <motion.div
                                initial={isSmartphone ? { opacity: 0, x: '-100%' } : null}
                                animate={isSmartphone ? { opacity: 1, x: 0 } : null}
                                transition={isSmartphone ? { duration: 1, delay: 0 } : null}
                            >
                                <Box sx={{
                            ...
                            >
                                <Box sx={{
                                    ...
                                    <Box sx={{
                                        ...
                                        <motion.div
                                            initial={ isSmartphone ? { opacity: 0, x: '-100%' } : { opacity: 0, x: '100%' }}
                                            animate={ isSmartphone ? { opacity: 1, x: 0 } : { opacity: 1, x: 0 }}
                                            transition={{ duration: 2, delay: 0 }}
                                        >
                                            <Box sx={{
                                                display: 'flex',
